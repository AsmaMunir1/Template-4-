    ...
    <div className="w-full bg-gray-50">
      ...
      <div className="max-w-[1200px] mx-auto px-4 py-12 flex flex-wrap gap-12">
        ...
        <div className="flex-1">
          ...
          i am passionate web developer insha Allah dedicated to bringing creativity and innovation to
           every project undertake .whether youre seeking captivating visual designs or sleek user-friendly web sites .
           you will come to the right plce
          </p>
          ...
          <p className="text-gray-600 mb-6">
            Insha allah I will do my work diligently
          </p>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div className="text-gray-600">
                <p>Tel: 1223455667</p>
                <p>E-Mail: aneelaisrar125@gmail.com</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
