...
function TopCategories() {
  const categories = [
    { id: 1, img: "/image 1170.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 2, img: "/image-1164.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 3, img: "/image.png", name: "Mini LCW Chair", price: "$56.00" },
    { id: 4, img: "/chair12.png", name: "Mini LCW Chair", price: "$56.00" },
  ];
